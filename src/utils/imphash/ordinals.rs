//! Ordinal names used by the import hash.
//!
//! Generated from pefile's `ordlookup/imphash_ws2_32.py` and
//! `ordlookup/imphash_oleaut32.py`, which freeze the mappings the original
//! imphash implementation used so values stay comparable with pefile, YARA,
//! YARA-X, and VirusTotal. Do not edit the entries: changing one changes the
//! imphash of every file that imports that ordinal.

/// `ws2_32.dll`, also used for `wsock32.dll` as in the original implementation.
pub(super) const WS2_32: &[(u16, &str)] = &[
    (1, "accept"),
    (2, "bind"),
    (3, "closesocket"),
    (4, "connect"),
...
/// `oleaut32.dll`.
pub(super) const OLEAUT32: &[(u16, &str)] = &[
    (2, "SysAllocString"),
    (3, "SysReAllocString"),
    (4, "SysAllocStringLen"),
