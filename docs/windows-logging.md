...
`service: windefend` reads the `Microsoft-Windows-Windows Defender/Operational` channel. Check that this channel is enabled with `wevtutil gl "Microsoft-Windows-Windows Defender/Operational"`.
